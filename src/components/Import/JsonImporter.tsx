...
import { Upload, FileJson, AlertCircle, Check, Copy, BookOpen, List } from 'lucide-react';
        ...
        <div className="h-full flex flex-col gap-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-slate-400">Paste AI-generated JSON to create new study sets.</p>
                </div>
                <button
